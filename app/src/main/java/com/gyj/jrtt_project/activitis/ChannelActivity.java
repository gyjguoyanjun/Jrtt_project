...
import com.gyj.jrtt_project.view.MyGridView;
import com.gyj.jrtt_project.R;
import com.gyj.jrtt_project.adapters.OtherAdapter;
            ...
            case R.id.otherGridView:
                ...
                if (moveImageView != null && flag) {
                   /* ContentValues values2 = new ContentValues();
                    values2.put("style", "1");
                    db.update("channel",values2,mUserList.get(position),null);*/
                    flag = !flag;
                    TextView newTextView = (TextView) view.findViewById(R.id.text_item);
                    final int[] startLocation = new int[2];
                    newTextView.getLocationInWindow(startLocation);
                    ...
                    //String item = mUserAdapter.getItem(position);
                    ContentValues values = new ContentValues();
                    values.put("style", "1");
